...
var ListThreadReactions = function(session) {
    /*
        Create a new instance of the ListThreadReactions Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Disqus/Threads/ListThreadReactions"
    ListThreadReactions.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ListThreadReactionsResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new ListThreadReactionsInputSet();
    }
...
var ListThreadReactionsInputSet = function() {
    ListThreadReactionsInputSet.super_.call(this);
        /*
        Set the value of the Cursor input for this Choreo. ((optional, string) Default is set to null.)
        */
        this.set_Cursor = function(value) {
...
var ListThreadReactionsResultSet = function(resultStream) {
    ListThreadReactionsResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Disqus.)
        */
        this.get_Response = function() {
...
util.inherits(ListThreadReactions, choreography.Choreography);
util.inherits(ListThreadReactionsInputSet, choreography.InputSet);
util.inherits(ListThreadReactionsResultSet, choreography.ResultSet);
exports.ListThreadReactions = ListThreadReactions;
